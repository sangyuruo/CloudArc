...
class MeterCategoryRuleGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the MeterCategoryRule entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "meterCategoryCode":"0", "ruleName":"SAMPLE_TEXT", "createdBy":"SAMPLE_TEXT", "createTime":"2020-01-01T00:00:00.000Z", "updatedBy":"SAMPLE_TEXT", "updateTime":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
