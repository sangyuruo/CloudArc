...
public class MeterRule implements Serializable {
    ...
    @Column(name = "meter_code", length = 100, nullable = false)
    ...
    public MeterRule createTime(ZonedDateTime createTime) {
    ...
    public MeterRule updateTime(ZonedDateTime updateTime) {
